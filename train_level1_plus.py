...
def main():
    ...
    image_path = os.path.join(data_root, "level1-450_plus_splited")  # flower data set path
    ...
    with open('level1_plus_class_indices.json', 'w') as json_file:
    ...
    # net = MobileNetV2(6)
    # model_weight_path = 'weight-1/MobileNetV2_level1_best.pth'
    ...
    # best_acc = 0.0
    best_acc = 0.
    save_path_best = 'weight-1-plus/MobileNetV2_level1_best.pth'
    save_path_newest = 'weight-1-plus/MobileNetV2_level1_newest.pth'
