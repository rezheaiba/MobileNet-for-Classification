...
def main():
    ...
    image_path = os.path.join(data_root, "level4_aug_splited")  # flower data set path
    ...
    with open('level4_class_indices.json', 'w') as json_file:
    ...
    # net = MobileNetV2(6)
    # model_weight_path = 'weight/MobileNetV2_level1_best.pth'
    ...
    epochs = 90
    best_acc = 0.98
    save_path_best = 'weight-4/MobileNetV2_level4_best.pth'
    save_path_newest = 'weight-4/MobileNetV2_level4_newest.pth'
