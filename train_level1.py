...
def main():
    ...
    image_path = os.path.join(data_root, "level1-450_splited_gray")  # flower data set path
    ...
    with open('level1_class_indices.json', 'w') as json_file:
    ...
    net = MobileNetV2(6)
    # model_weight_path = 'weight/MobileNetV2_level1_newest.pth'
    ...
    # best_acc = 0.0
    best_acc = 0.0
    save_path_best = 'weight-1/MobileNetV2_level1_best.pth'
    save_path_newest = 'weight-1/MobileNetV2_level1_newest.pth'
