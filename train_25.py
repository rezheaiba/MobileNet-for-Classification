...
def main():
    ...
    image_path = os.path.join(data_root, "level1_aug_splited")  # flower data set path
    ...
    # # net.classifier = nn.Linear(in_channel, 6)
    # net.classifier = nn.Sequential(
    #     nn.Dropout(0.2),
    #     nn.Linear(in_channel, 6)
    # )
    ...
    best_acc = 0.83
    # best_acc = 0.937
    save_path_best = 'weight/MobileNetV2_level1_best.pth'
    save_path_newest = 'weight/MobileNetV2_level1_newest.pth'
