...
if __name__ == '__main__':
    # rename(folder=r'D:\Dataset\data\MTest')  # 对一个文件夹下深度遍历后的所有文件
    # random_name(folder = r'D:\Dataset\data\final-450-gray')  # 打乱文件夹中图片顺序
    # rename_folder(r'D:\Dataset\data\MTest')  # 根据文件夹名称对图片命名

    # rgb2gray(path=r"D:\Dataset\data\genrain\c_", save_path=r"D:\Dataset\data\genrain\c_")  # 彩转黑
    redtype(path=r"C:\Users\A\Desktop\新建文件夹 (3)", save_path=r"C:\Users\A\Desktop\新建文件夹 (3)")  # 把位深改为为24
