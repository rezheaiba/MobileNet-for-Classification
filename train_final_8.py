...
def main():
    ...
    image_path = os.path.join(data_root, "final-8")  # flower data set path
    ...
    net = MobileNetV2(7)
    model_weight_path = 'weight-final/MobileNetV2_final_best.pth'
    ...
    # best_acc = 0.0
    best_acc = 0.
    save_path_best = 'weight-final-8/MobileNetV2_final_best.pth'
    save_path_newest = 'weight-final-8/MobileNetV2_final_newest.pth'
