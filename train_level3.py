...
def main():
    ...
    image_path = os.path.join(data_root, "level3_splited")  # flower data set path
    ...
    with open('level3_class_indices.json', 'w') as json_file:
    ...
    epochs = 60
    best_acc = 0.989
    save_path_best = 'weight-3/MobileNetV2_level3_best.pth'
    save_path_newest = 'weight-3/MobileNetV2_level3_newest.pth'
