...
from model_v2 import LabelSmoothing
...
def main():
    ...
    image_path = os.path.join(data_root, "level2-600_splited")  # flower data set path
    ...
    with open('level2_class_indices.json', 'w') as json_file:
    ...
    # 增加normal类
    # net = MobileNetV2(3)
    # model_weight_path = 'weight-2/MobileNetV2_level2_best.pth'
    ...
    epochs = 30
    best_acc = 0.96
    save_path_best = 'weight-2/MobileNetV2_level2_best.pth'
    save_path_newest = 'weight-2/MobileNetV2_level2_newest.pth'
